...
void TextureManager::DrawTile(std::string tilesetID, int tileSize, int x, int y, int row, int column,
                              SDL_RendererFlip flip) {
    SDL_Rect srcRect = {tileSize * column, tileSize * (row - 1), tileSize, tileSize};
